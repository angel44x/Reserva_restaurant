...
<figure class="banner">
	...
	<div class="textoBanner textoDer">
		...
		<h1 style="color:#fff">TU SALUD </h1>

		<h2 style="color:#fff"><strong>NOS</strong></h2>

		<h3 style="color:#fff">IMPORTA</h3>
		...
		<div class="row">
			...
			<div class="col-xs-12 tituloDestacado">
				...
				<div class="col-sm-6 col-xs-12">
					...
					<h1><small>RECOMENDADOS </small></h1>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/backend/vistas/img/productos/menu/menu04.jpg" class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/backend/vistas/img/productos/extras/extra03.jpg" class="img-responsive">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs deseos" idProducto="14" data-toggle="tooltip" title="Agregar a mi lista de deseos">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/backend/vistas/img/productos/pizzas/pizza03.jpg" class="img-responsive">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs deseos" idProducto="15" data-toggle="tooltip" title="Agregar a mi lista de deseos">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/backend/vistas/img/productos/postres/postre02.jpg" class="img-responsive">
				...
				<div class="col-xs-6 enlaces">
					...
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs deseos" idProducto="16" data-toggle="tooltip" title="Agregar a mi lista de deseos">
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img src="http://localhost/backend/vistas/img/productos/menu/menu04.jpg" class="img-responsive"></a>
				...
				<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
					...
					<h1>
						<small>
							...
							<a href="#" class="pixelProducto">Arroz con pollo</a>

						</small>

					</h1>

					<p class="text-muted">Ven y disfruta el rico aroz con pollo al restaurante el rinconcito</p>
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img src="http://localhost/backend/vistas/img/productos/extras/extra03.jpg" class="img-responsive"></a>
				...
				<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
					...
					<h1>
						<small>
							...
							<a href="#" class="pixelProducto">Hamburguesa</a>

						</small>

					</h1>

					<p class="text-muted">Disfruta de las deliciosas hamburguesas como hechas en casa</p>
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img src="http://localhost/backend/vistas/img/productos/pizzas/pizza03.jpg" class="img-responsive"></a>
				...
				<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
					...
					<h1>
						<small>
							...
							<a href="#" class="pixelProducto">peperoni</a>

						</small>

					</h1>

					<p class="text-muted">No hay nada mas delicioso que disfrutar de una deliciosa piza de peperoni.</p>
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12">
					...
					<figure>
						...
						<a href="#" class="pixelProducto"><img src="http://localhost/backend/vistas/img/productos/postres/postre02.jpg" class="img-responsive"></a>
				...
				<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
					...
					<h1>
						<small>
							...
							<a href="#" class="pixelProducto">Yogurt con granola</a>

						</small>

					</h1>

					<p class="text-muted">Ven a disfrutar un delicioso yogur con granola a la jugueria fresh fruta.</p>
