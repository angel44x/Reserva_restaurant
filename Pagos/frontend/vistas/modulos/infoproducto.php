				...
				<?php
					...
					if($infoproducto["detalles"] != null){
						...
						if($infoproducto["tipo"] == "fisico"){
							...
							if($detalles["Cuanto"]!=null){

								echo '<div class="col-md-3 col-xs-12">

									<select class="form-control seleccionarDetalle" id="seleccionarCuanto">
										
										<option value="">Cuanto</option>';

										for($i = 0; $i <= count($detalles["Cuanto"]); $i++){

											echo '<option value="'.$detalles["Cuanto"][$i].'">'.$detalles["Cuanto"][$i].'</option>';
							...
							if($detalles["Restaurante"]!=null){

								echo '<div class="col-md-3 col-xs-12">

									<select class="form-control seleccionarDetalle" id="seleccionarRestaurante">
										
										<option value="">Restaurante</option>';

										for($i = 0; $i <= count($detalles["Restaurante"]); $i++){

											echo '<option value="'.$detalles["Restaurante"][$i].'">'.$detalles["Restaurante"][$i].'</option>';
